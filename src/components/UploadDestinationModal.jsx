...
export default function UploadDestinationModal({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-start justify-center overflow-y-auto px-3 py-4 sm:items-center sm:px-4">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      <motion.div
        ...
        className="relative z-10 flex w-[calc(100vw-1rem)] max-w-[72rem] max-h-[calc(100dvh-2rem)] flex-col overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-[0_30px_100px_rgba(15,23,42,0.35)] sm:w-[calc(100vw-2rem)] sm:max-h-[calc(100dvh-3rem)] sm:rounded-[28px]"
      >
