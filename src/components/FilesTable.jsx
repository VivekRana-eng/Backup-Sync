                  ...
                  >
                        ...
                        {isRenaming ? (
                          <div className="flex items-center gap-1">
                            ...
                            <button
                              ...
                              className="bg-slate-900 hover:bg-black text-white font-bold text-[10px] py-1 px-2 rounded-lg cursor-pointer"
                            >
                              Save
                            </button>
                            <button
                              ...
                              onMouseDown={(e) => e.stopPropagation()}
                              className="bg-slate-100 hover:bg-slate-200 text-slate-600 text-[10px] py-1 px-2 rounded-lg cursor-pointer"
                            >
                              Cancel
                            </button>
                          </div>
                          ...
                          <span
                            ...
                            className="font-bold text-slate-800 truncate block hover:text-slate-900 cursor-pointer text-xs sm:text-sm"
                    ...
                    <td className="pr-5 md:pr-6 py-4 text-right whitespace-nowrap relative" ref={isDropdownOpen ? dropdownRef : undefined}>
                      ...
                      {isDropdownOpen && (
                        ...
                        className="absolute right-6 mt-1 w-48 rounded-2xl border border-slate-200 bg-white/95 shadow-[0_18px_45px_rgba(15,23,42,0.16)] backdrop-blur-sm z-50 overflow-hidden py-1 transform origin-top-right transition-all duration-200"
                      >
                          <button
                            onClick={() => {
          ...
          {filteredFiles.map((file) => {
            ...
            return (
              <div
                ...
                className="bg-white border border-slate-200 rounded-2xl p-4.5 hover:shadow-md transition-all relative overflow-hidden group flex flex-col justify-between"
              >
                {/* Ribbon top card bar */}
                  ...
                  {isRenaming ? (
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="flex gap-1 justify-end">
                        <button
                          onClick={() => saveRename(file.id)}
                        className="bg-slate-900 font-bold text-[9px] text-white py-0.5 px-2 rounded-md"
                        >
                          Save
                        </button>
                        <button
